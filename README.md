...
- Taxa de gain configurável por estratégia, aplicada de forma composta sobre o saldo operacional total corrente (`saldo × (1 + taxa)^N`); saldos de redistribuição permanecem contabilizados separadamente
