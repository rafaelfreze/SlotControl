...
- Contrato versionado: `apps/web/lib/coinops-reports`, `report_version = 7`. Ao mudar semântica ou formato, versionar e atualizar fontes, regras, checks, CSV/JSON, documentação e testes juntos.
