...
export default async function AutomationPage() {
  ...
  const [connectionResponse, runsResponse, robotConfigsResponse, robotCyclesResponse, robotSlotsResponse, intentsResponse] = await Promise.all([
    ...
    supabase.from("robot_v1_slots").select("id,cycle_id,slot_number,buy_price,requested_quantity,buy_status,executed_quantity,average_fill_price,take_profit_price,take_profit_status,status,realized_quote_pnl").order("slot_number"),
