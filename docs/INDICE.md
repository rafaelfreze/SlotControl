...
- [Automação ao vivo](./COINOPS_AUTOMATION_REALTIME.md) — sinais Realtime por motor, preços públicos, fallback e indicadores de desatualização sem writes no browser.
