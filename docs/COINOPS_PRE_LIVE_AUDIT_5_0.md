...
| AUD-05 | MEDIUM | Dois checks históricos tratavam preço anterior ausente como zero. Ausência é WARNING; divergência de preços realmente comprovada continua FAIL. Eventos históricos permanecem intactos. |
...
- Suíte completa: **491/491 PASS, zero SKIP**. Inclui 49 casos PostgreSQL reais (29 ledger, 16 partial/restart, quatro configuração ATH), com clusters efêmeros locais e rollback. Nenhum teste financeiro usou o Supabase vinculado.
