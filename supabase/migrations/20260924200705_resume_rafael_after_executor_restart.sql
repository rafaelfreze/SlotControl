-- First guarded attempt: no rows changed because a LIVE cron held the lease.
with snapshot as materialized (
  select '2026-09-24T20:06:44.485Z'::timestamptz at
  where '2026-09-24T20:06:44.485Z'::timestamptz between now()-interval '90 seconds' and now()+interval '5 seconds'
